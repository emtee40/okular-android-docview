...
Kirigami.OverlaySheet
{
    ...
    // Without this the with is unreasonably narrow, potentially
    ...
    property bool widthWorkaround: false

    title: i18n("Certificate Viewer")

    ColumnLayout {
        Layout.preferredWidth: root.widthWorkaround ? Window.window.width : 0
