    ...
    , m_prevAnchorPos(prevAnchorPos)
{
    ...
    if (m_prevCursorPos != m_prevAnchorPos) {
    ...
    } else if (newContentsRightOfCursor() == oldContentsRightOfCursor() && newContentsLeftOfCursor() == oldContentsLeftOfCursor().left(oldContentsLeftOfCursor().length() - 1) && !oldContentsLeftOfCursor().endsWith(QLatin1Char('\n'))) {
        ...
        m_editType = CharBackspace;
               ...
               !oldContentsRightOfCursor().startsWith(QLatin1Char('\n'))) {
        qCDebug(OkularCoreDebug) << "CharDelete";
        m_editType = CharDelete;
    } else if (newContentsRightOfCursor() == oldContentsRightOfCursor() && newContentsLeftOfCursor().left(newContentsLeftOfCursor().length() - 1) == oldContentsLeftOfCursor() && !newContentsLeftOfCursor().endsWith(QLatin1Char('\n'))) {
