...
Okular::CertificateInfo::CertificateInfo(Okular::CertificateInfo &&other) = default;
...
void CertificateInfo::setCheckPasswordFunction(std::function<bool(const QString &)> passwordFunction)
{
