...
CertificateInfo::CertificateInfo() : d{new CertificateInfoPrivate()}
{
}

Okular::CertificateInfo::CertificateInfo(const Okular::CertificateInfo& other) = default;
Okular::CertificateInfo::CertificateInfo(Okular::CertificateInfo && other)
 = default;
Okular::CertificateInfo & Okular::CertificateInfo::operator=(const Okular::CertificateInfo& other) = default;
CertificateInfo& Okular::CertificateInfo::operator=(Okular::CertificateInfo && other) = default;
...
void CertificateInfo::setCheckPasswordFunction(std::function<bool (QString)> passwordFunction)
{
...
SignatureInfo::SignatureInfo() : d{new SignatureInfoPrivate()}
{
}

SignatureInfo::SignatureInfo(SignatureInfo && other) = default;
SignatureInfo::SignatureInfo(const SignatureInfo& other) = default;
SignatureInfo& SignatureInfo::operator=(SignatureInfo && other) = default;
...
void Okular::SignatureInfo::setSigningTime(QDateTime time)
{
    d->signingTime = time;
}
