...
inline KAboutData okularAboutData()
{
    ...
    about.setEnergyEfficiencyData(QStringLiteral("https://invent.kde.org/teams/eco/blue-angel-application/-/blob/master/applications/okular/de-uz-215-eng-annex-7-okular.xml"));
    about.setMinimalSystemRequirements(QStringLiteral(""));
    about.setOpenLicense(QStringLiteral("https://invent.kde.org/graphics/okular/-/blob/master/COPYING"));
    about.setSourceCode(QStringLiteral("https://invent.kde.org/graphics/okular"));
    about.setApiDocumentation(QStringLiteral("https://api.kde.org/okular/html/index.html"));
    about.setDataFormatDocumentation(QStringLiteral("https://okular.kde.org/formats"));
