...
{
public:
    explicit PdfPrintJob(QPrinter &_printer, const Okular::Document *_document, Poppler::Document *_pdfdoc, QPointer<PDFOptionsPage> _pdfOptionsPage, const QString &_title, QMutex *_mutex)
        : Okular::PrintJob()
        , document(_document)
        , pdfdoc(_pdfdoc)
        , printer(_printer)
