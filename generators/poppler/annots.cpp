...
// TODO crating code should be ideally joined
static void setSharedAnnotationPropertiesToPopplerAnnotation(const Okular::Annotation *okularAnnotation, Poppler::Annotation *popplerAnnotation)
{
    ...
    const Okular::Annotation::Style oStyle = okularAnnotation->style();
    ...
    popplerAnnotation->setStyle(pStyle);

    Poppler::Annotation::Popup pWindow;
    const Okular::Annotation::Window oWindow = okularAnnotation->window();
    ...
    popplerAnnotation->setPopup(pWindow);
