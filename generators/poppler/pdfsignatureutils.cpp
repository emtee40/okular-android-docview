...
Okular::CertificateInfo fromPoppler(const Poppler::CertificateInfo& pInfo)
{
    ...
    for (auto key : { Poppler::CertificateInfo::EntityInfoKey::CommonName, Poppler::CertificateInfo::EntityInfoKey::DistinguishedName, Poppler::CertificateInfo::EntityInfoKey::EmailAddress, Poppler::CertificateInfo::EntityInfoKey::Organization} ) {
    ...
    oInfo.setCheckPasswordFunction([pInfo](QString password) {
