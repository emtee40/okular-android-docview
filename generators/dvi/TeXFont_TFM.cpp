...
#ifdef DEBUG_TFM
    qCDebug(OkularDviDebug) << "lf= " << lf << "lh= " << lh << Qt::endl << "bc= " << bc << Qt::endl << "ec= " << ec << Qt::endl << "nw= " << nw << Qt::endl << "nh= " << nh << Qt::endl << "nd= " << nd;
#endif
...
#ifdef DEBUG_TFM
    qCDebug(OkularDviDebug) << "checksum    = " << checksum << "design_size = " << design_size_in_TeX_points.toDouble() << " TeX Points" << Qt::endl << "            = " << design_size_in_TeX_points.toDouble() * 254.0 / 7227.0 << " cm";
#endif
