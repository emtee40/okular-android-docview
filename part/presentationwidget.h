...
private:
    const void *getObjectRect(Okular::ObjectRect::ObjectType type, const QPointF& point, QRect *geometry = nullptr) const;
    const Okular::Action *getLink(const QPointF& point, QRect *geometry = nullptr) const;
    const Okular::Annotation *getAnnotation(const QPointF& point, QRect *geometry = nullptr) const;
    void testCursorOnLink(const QPointF& point);
