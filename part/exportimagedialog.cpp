...
void ExportImageDialog::initUI()
{
    ...
    *m_dirPath = QDir::homePath();
    ...
    connect(defaultQualityRadioButton, &QRadioButton::toggled, this, [=]() { qualitySlider->setEnabled(false); });

    connect(customQualityRadioButton, &QRadioButton::toggled, this, [=]() { qualitySlider->setEnabled(true); });
