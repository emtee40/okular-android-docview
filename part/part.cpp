    ...
    if (modified && !m_save->isEnabled()) {
        if (!m_warnedAboutModifyingUnsaveableDocument) {
            ...
            KMessageBox::information(
                widget(), i18n("You have just modified the open document, but this kind of document can not be saved.\nAny modification will be lost once Okular is closed."), i18n("Document can't be saved"), "warnAboutUnsaveableDocuments");
        }
    }
}
