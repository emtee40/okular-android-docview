...
static const QString DesktopEntryGroupKey = QStringLiteral("Desktop Entry");
static const QString RecentFilesGroupKey = QStringLiteral("Recent Files");
static const QString GeneralGroupKey = QStringLiteral("General");
