...
void DocumentTest::testDiff_data()
{
    ...
    QTest::addRow("empty") << "" << "" << "";
    QTest::addRow("a") << "" << "a" << "a";
    QTest::addRow("ab") << "a" << "b" << "b";
    QTest::addRow("ab2") << "a" << "ab" << "b";
    QTest::addRow("kaesekuchen") << "Käse" << "Käsekuchen" << "kuchen";
    QTest::addRow("replace") << "kuchen" << "wurst" << "wurst";
    QTest::addRow("okular") << "Oku" << "Okular" << "lar";
    QTest::addRow("removal1") << "a" << "" << "";
    QTest::addRow("removal2") << "ab" << "a" << "";
    QTest::addRow("unicode") << "☮🤌" << "☮🤌❤️" << "❤️";
}
