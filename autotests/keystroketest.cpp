...
void KeystrokeTest::testKeystroke()
{
    ...
    // accept
    m_document->processKeystrokeAction(fft->additionalAction(Okular::FormField::FieldModified), fft, "hello");
    QCOMPARE(fft->text(), "hello");

    // accept
    m_document->processKeystrokeAction(fft->additionalAction(Okular::FormField::FieldModified), fft, "e");
    QCOMPARE(fft->text(), "e");

    // accept
    m_document->processKeystrokeAction(fft->additionalAction(Okular::FormField::FieldModified), fft, "ee");
    QCOMPARE(fft->text(), "ee");

    // accept
    m_document->processKeystrokeAction(fft->additionalAction(Okular::FormField::FieldModified), fft, "eee");
    QCOMPARE(fft->text(), "eee");

    // reject
    m_document->processKeystrokeAction(fft->additionalAction(Okular::FormField::FieldModified), fft, "eeef");
    QCOMPARE(fft->text(), "eee");
}
