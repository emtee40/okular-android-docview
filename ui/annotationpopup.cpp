...
void AnnotationPopup::doRemovePageAnnotation(const AnnotPagePair &pair)
{
...
void AnnotationPopup::doOpenAnnotationWindow(const AnnotPagePair &pair)
{
    emit openAnnotationWindow(pair.annotation, pair.pageNumber);
}

void AnnotationPopup::doOpenPropertiesDialog(const AnnotPagePair &pair)
{
    if (pair.pageNumber != -1) {
...
void AnnotationPopup::doSaveEmbeddedFile(const AnnotPagePair &pair)
{
